...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/timeline/work-order-scheduling#).
...
You can use the
[date header template](https://demo.mobiscroll.com/jquery/timeline/hour-day-week-month-quarter-year-header-footer-template#)
and add a simple
[event template](https://demo.mobiscroll.com/jquery/timeline/timeline-custom-event-rendering#)
