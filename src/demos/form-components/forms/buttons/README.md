...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/forms/buttons#).
...
- **Customize the look & feel:** [See how to apply color presets →](https://demo.mobiscroll.com/jquery/forms/button-segmented-stepper-colors#)

## Related demos

- [See how to apply color presets →](https://demo.mobiscroll.com/jquery/forms/button-segmented-stepper-colors#)
