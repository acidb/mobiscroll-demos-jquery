...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/select/rtl-right-to-left#).
...
- **Explore the different locales** [Check out this example →](https://demo.mobiscroll.com/jquery/select/localization#)

## Related demos

- [Check out this example →](https://demo.mobiscroll.com/jquery/select/localization#)
