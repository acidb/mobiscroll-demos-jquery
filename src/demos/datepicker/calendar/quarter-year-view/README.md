...
Create a calendar with quarter views that can be navigated quarter by quarter or switch to a year view on the fly. Show any relevant information with [labels or add background colors](https://demo.mobiscroll.com/jquery/calendar/dots-colors-labels#) to days along with [week counters](https://demo.mobiscroll.com/jquery/calendar/month-change-direction-week-numbers-outer-days#).
