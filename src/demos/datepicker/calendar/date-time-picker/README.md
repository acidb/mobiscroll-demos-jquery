...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/calendar/date-time-picker#).
...
- **Interested in dynamically switching between modes?** [Learn how to set up responsive behavior →](https://demo.mobiscroll.com/jquery/calendar/responsive#)

## Related demos

- [Learn how to set up responsive behavior →](https://demo.mobiscroll.com/jquery/calendar/responsive#)
