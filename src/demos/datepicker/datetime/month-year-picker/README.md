...
To see this example live, check it out on our [demo page](https://demo.mobiscroll.com/jquery/datetime/month-year-picker#).
...
- **Interested in changing the date format?** [Explore formatting options →](https://demo.mobiscroll.com/jquery/datetime/formatting-return-values#)

## Related demos

- [Explore formatting options →](https://demo.mobiscroll.com/jquery/datetime/formatting-return-values#)
