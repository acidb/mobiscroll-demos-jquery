...
- **Interested in localization?** [Explore this example →](https://demo.mobiscroll.com/jquery/range/localization#)

## Related demos

- [Explore this example →](https://demo.mobiscroll.com/jquery/range/localization#)
